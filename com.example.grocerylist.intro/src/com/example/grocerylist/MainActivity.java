...
public class MainActivity extends Activity {
	...
	private ListView gList; // Grocery List
	private Button recipeBtn, sLocatorBtn, editBtn; // Main Menu buttons
	private ListAdapter recipeAdtr; // Recipe Adapter
	private ListAdapter listAdtr; // Grocery List Adapter
	private Button aboutBtn, searchBtn, settingsBtn;
	
	
	// The following string array is just for testing purposes
	private static final String[] groceryList={"Friday's Dinner", "Halloween Candy", "My next recipe",
   ...
   private void AddItemToMyList()
    {
    	LayoutInflater inflater = getLayoutInflater();
    	View layoutDialog = inflater.inflate(R.layout.add_mylist_dialog, null);
    	
    	// creates the dialog it must be set to final otherwise buttons won't work
    	final Dialog dialogAddItemToMylis = new Dialog(this,android.R.style.Theme_Translucent_NoTitleBar);
    	Button cancelBtn = (Button)layoutDialog.findViewById(R.id.button3);
    	layoutDialog.showContextMenu();
    }  
}
